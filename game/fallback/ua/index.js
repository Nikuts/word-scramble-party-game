// game/fallback/ua/index.js
import { UA_HARVESTER_QUESTIONS } from './questions.js';
...
export const FALLBACK_CONTENT_UA = rawPacks.map(pack => ({
    theme: pack.theme,
    battlePrompts: pack.battlePrompts,
    playerQuestions: UA_HARVESTER_QUESTIONS
}));
